...
function joints_language_links() {
	wp_nav_menu(array(
		...
		'menu_class'		=> 'language-menu',				// Adding custom nav class
...
// The Resources Menu
function joints_mobile_footer_links() {
	wp_nav_menu(array(
		'container'			=> 'false',				// Remove nav container
		'menu_id'			=> 'mobile-footer-links',		// Adding custom nav id
		'menu_class'		=> 'menu',				// Adding custom nav class
		'theme_location'	=> 'mobile-footer-links',		// Where it's located in the theme
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-responsive-menu="accordion medium-dropdown">%3$s</ul>',
		'depth'				=> 0,					// Limit the depth of the nav
		'fallback_cb'		=> '',					// Fallback function
		'walker'			=> new Off_Canvas_Menu_Walker()
